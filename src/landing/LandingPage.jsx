    ...
    <section className="section shell reveal" id="comparison" aria-labelledby="comparison-title">
      ...
      <div className="comparison-frame" aria-label="Illustrative document pipeline comparison">
        ...
        <div className="comparison-scoreboard" role="group" aria-label="Document understanding capability matrix">
          <div className="comparison-scoreboard-head"><strong>Capability matrix</strong><div className="comparison-scoreboard-head-actions"><button className="comparison-toggle" type="button" aria-expanded="false" aria-controls="comparison-table"><span data-comparison-toggle-label>View details</span></button></div></div>
    ...
    <section className="section shell reveal" id="pricing" aria-labelledby="pricing-title">
      <div className="pricing-card">
        ...
        <div className="pricing-calculator">
          ...
          <div className="pricing-control-card"><label className="sr-only" htmlFor="pricing-pages">Pages to process</label><div className="pricing-range-control"><span className="pricing-range-fill" data-pricing-range-fill style={{'--pricing-progress': '4.0404%'}} aria-hidden="true" /><span className="pricing-range-handle" data-pricing-range-handle style={{'--pricing-progress': '4.0404%'}} aria-hidden="true" /><span className="pricing-range-budget" data-pricing-range-budget style={{'--pricing-progress': '4.0404%'}}><strong data-pricing-price>$7.50</strong></span><span className="pricing-drag-hint" aria-hidden="true"><i />Drag to estimate</span><input className="pricing-range" id="pricing-pages" type="range" min={100} max={10000} step={100} defaultValue={500} aria-label="Pages to process" /></div></div>
        </div>
